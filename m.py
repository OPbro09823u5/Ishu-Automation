...
bot = telebot.TeleBot('7471064204:AAFFnxAZjDwHfHRcAyDvJxSLm85q4-pC8EM')

# Admin user IDs
admin_id = ["5361369651","1374066790","872835181"]
...
def welcome_start(message):
    ...
    response = f'''👋🏻Welcome to ARUP FREE DDOS🚀, {user_name}! ⚠️ PAID BHI SASTA HAI KHARID LO ABHI .
